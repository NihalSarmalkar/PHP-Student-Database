            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    output += "<tr> <td> " +
                        ...
                        data[i].email + "</td><td>" +
                        data[i].password +
                        "</td><td> <button class = ' btn btn-sm btn-edit editButton'data-sid = " + data[i].id + ">Edit</button> <button class = 'btn btn-sm btn-del deletButton' data-sid = " + data[i].id + "> Delete </button>" +"</td> </tr>"
